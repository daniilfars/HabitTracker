...
- Календарь активностей за последний год (агрегация по всем привычкам пользователя)
- Подсчёт текущей и лучшей серии выполнения (streak)
- Серия не сбрасывается в дни, когда у пользователя нет запланированных привычек
- Данные для календаря включают количество выполненных и всего запланированных привычек на каждый день
