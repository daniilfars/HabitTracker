...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest client.client -- --template=react  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`client.client.esproj`).
